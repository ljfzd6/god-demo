...
<div class="yunyan_logo">
      ...
      <form name="f"  method="post" id="login_form" @submit.prevent="login()">
      <input name="user" id="user" placeholder="Username" type="text" required="" class="user" v-model="username">
      <hr class="hr15">
      <input name="pw" id="pw" placeholder="Password" type="password" required="" v-model="password">
<hr class="hr15">
